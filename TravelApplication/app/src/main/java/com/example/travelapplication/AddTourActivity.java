...
public class AddTourActivity extends AppCompatActivity {
    ...
    private void insertData(){
        ...
        map.put("name", ed_tenTourAdd.getText().toString());
        map.put("nameProvince", ed_tenTinhAdd.getText().toString());
        ...
        FirebaseDatabase.getInstance().getReference().child("tour").push()
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(AddTourActivity.this, "Data Insert Successfully", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddTourActivity.this, "Error While Insertion", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}